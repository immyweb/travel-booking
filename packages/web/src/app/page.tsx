...
import { DealsSection, type Deal } from './_components/DealsSection';
import { DealsSkeleton } from './_components/DealsSkeleton';
import { displayFont } from './_components/fonts';
import { HeroSearchForm } from './_components/HeroSearchForm';
import { HomeFooter } from './_components/HomeFooter';
import { HomeHeader } from './_components/HomeHeader';
import { TileDivider } from './_components/TileDivider';
import { TileMark } from './_components/TileMark';
        ...
        <section className="relative isolate overflow-hidden bg-gradient-to-br from-azulejo to-azulejo-light px-6 pt-14 pb-24 text-white sm:pt-20 sm:pb-28">
          ...
          <div className="motion-safe:animate-[rise-in_0.7s_ease-out] relative mx-auto flex max-w-4xl flex-col items-start gap-6 text-left">
            ...
            <p className="max-w-xl text-lg text-white/80">
              Search real stays across Lisbon, Cascais, Sintra and Paris, and book direct in
              minutes.
            </p>
          </div>
